...
>
    ...
    <nav class="flex-1 overflow-y-auto sidebar-scroll py-3 px-2">
        ...
        {{-- Operations --}}
        <div class="mb-5">
            <p x-show="!collapsed" class="px-3 mb-2 text-[10px] font-semibold uppercase tracking-[0.12em] text-sidebar-text/30">Operations</p>
            ...
            <div x-data="{ open: {{ request()->is('admin/products*') || request()->is('admin/designs*') || request()->is('admin/skus*') || request()->is('admin/sku-mappings*') ? 'true' : 'false' }} }">
                ...
                <div x-show="open && !collapsed" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-0.5 mt-0.5">
                    ...
                    <a href="{{ route('admin.sku-mappings.index') }}" class="sidebar-sublink {{ request()->routeIs('admin.sku-mappings.*') ? 'active' : '' }}">Mappings</a>
                    <a href="{{ route('admin.products.import') }}" class="sidebar-sublink {{ request()->routeIs('admin.products.import*') ? 'active' : '' }}">Import</a>
                </div>
            </div>

            {{-- Inventory --}}
            <a href="#" class="sidebar-link" title="Inventory">
            ...
            {{-- Vendors --}}
            <div x-data="{ open: {{ request()->is('admin/vendors*') || request()->is('admin/vendor-portal*') ? 'true' : 'false' }} }">
                <button @click="open = !open" class="sidebar-link w-full justify-between">
                    <div class="flex items-center gap-3 min-w-0">
                ...
                <div x-show="open && !collapsed" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-0.5 mt-0.5">
                    <a href="{{ route('admin.vendors.index') }}" class="sidebar-sublink {{ request()->routeIs('admin.vendors.*') ? 'active' : '' }}">All Vendors</a>
                    <a href="{{ route('admin.vendor-portal.tokens') }}" class="sidebar-sublink {{ request()->routeIs('admin.vendor-portal.*') ? 'active' : '' }}">Vendor Portal</a>
                </div>
            </div>

            {{-- Procurement --}}
            <div x-data="{ open: {{ request()->is('admin/purchase-orders*') || request()->is('admin/reorder*') ? 'true' : 'false' }} }">
                <button @click="open = !open" class="sidebar-link w-full justify-between">
                    <div class="flex items-center gap-3 min-w-0">
                        ...
                        <span x-show="!collapsed" x-transition.opacity.duration.200ms class="sidebar-label">Procurement</span>
                    </div>
                    <svg x-show="!collapsed" :class="open ? 'rotate-90' : ''" class="w-3 h-3 text-sidebar-text/30 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                </button>
                <div x-show="open && !collapsed" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-0.5 mt-0.5">
                    <a href="{{ route('admin.purchase-orders.index') }}" class="sidebar-sublink {{ request()->routeIs('admin.purchase-orders.*') ? 'active' : '' }}">Purchase Orders</a>
                    <a href="{{ route('admin.reorder.dashboard') }}" class="sidebar-sublink {{ request()->routeIs('admin.reorder.dashboard') ? 'active' : '' }}">Reorder Engine</a>
                    ...
                    <a href="{{ route('admin.reorder.rules') }}" class="sidebar-sublink {{ request()->routeIs('admin.reorder.rules') ? 'active' : '' }}">Reorder Rules</a>
                </div>
            </div>
            ...
            <div x-data="{ open: {{ request()->is('admin/orders*') ? 'true' : 'false' }} }">
                ...
                <div x-show="open && !collapsed" x-collapse class="ml-4 pl-3 border-l border-white/5 space-y-0.5 mt-0.5">
                    <a href="#" class="sidebar-sublink">Meesho</a>
                    <a href="#" class="sidebar-sublink">Flipkart</a>
                </div>
            </div>

            {{-- Labels & Manifest --}}
            <a href="#" class="sidebar-link" title="Labels & Manifest">
                ...
                <span x-show="!collapsed" x-transition.opacity.duration.200ms class="sidebar-label">Labels & Manifest</span>
            </a>

            {{-- Shipments --}}
            <a href="{{ route('admin.shipments.index') }}" class="sidebar-link {{ request()->routeIs('admin.shipments.*') ? 'active' : '' }}" title="Shipments">
            ...
            {{-- Scanning --}}
            <a href="{{ route('admin.scan.index') }}" class="sidebar-link {{ request()->routeIs('admin.scan.*') ? 'active' : '' }}" title="Scanning">
        ...
        <div class="mb-5">
            ...
            <a href="{{ route('admin.marketplace-config.index') }}" class="sidebar-link {{ request()->routeIs('admin.marketplace-config.*') ? 'active' : '' }}" title="Marketplace Settings">
        ...
        <div class="mb-5">
            ...
            {{-- Returns & RTO --}}
            <a href="{{ route('admin.returns.index') }}" class="sidebar-link {{ request()->routeIs('admin.returns.*') ? 'active' : '' }}" title="Returns & RTO">
            ...
            {{-- Claims --}}
            <a href="{{ route('admin.claims.index') }}" class="sidebar-link {{ request()->routeIs('admin.claims.*') ? 'active' : '' }}" title="Claims">
        ...
        <div class="mb-5">
            ...
            {{-- Settlements --}}
            <a href="{{ route('admin.settlements.index') }}" class="sidebar-link {{ request()->routeIs('admin.settlements.*') ? 'active' : '' }}" title="Settlements">
            ...
            {{-- Payments --}}
            <a href="{{ route('admin.payments.index') }}" class="sidebar-link {{ request()->routeIs('admin.payments.*') ? 'active' : '' }}" title="Payments">
            ...
            {{-- Bank Accounts --}}
            <a href="{{ route('admin.bank-accounts.index') }}" class="sidebar-link {{ request()->routeIs('admin.bank-accounts.*') ? 'active' : '' }}" title="Bank Accounts">
        ...
        <div class="mb-4">
            ...
            {{-- Exceptions --}}
            <a href="{{ route('admin.exceptions.index') }}" class="sidebar-link {{ request()->routeIs('admin.exceptions.*') ? 'active' : '' }}" title="Exceptions">
            ...
            {{-- Notifications --}}
            <a href="{{ route('admin.notifications.index') }}" class="sidebar-link {{ request()->routeIs('admin.notifications.*') ? 'active' : '' }}" title="Notifications">
            ...
            <a href="#" class="sidebar-link" title="Reports">
                <svg class="sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                <span x-show="!collapsed" x-transition.opacity.duration.200ms class="sidebar-label">Reports</span>
            </a>
